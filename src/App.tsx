...
const INITIAL_SERVICES: Service[] = [
  { id: '1', name: 'Corte Masculino Premium', price: 55, durationMinutes: 35, category: 'Cabelo', description: 'Corte moderno com lavagem e alinhamento de fios.' },
  { id: '2', name: 'Barba de Respeito com Toalha Quente', price: 45, durationMinutes: 30, category: 'Barba', description: 'Barboterapia completa com óleos essenciais e toalha quente.' },
  { id: '3', name: 'Pezinho & Acabamento Navalhado', price: 25, durationMinutes: 15, category: 'Acabamento', description: 'Contorno perfeito de pezinho e barba alinhados na navalha.' },
  ...
  { id: '7', name: 'Combo BarberLab (Cabelo + Barba)', price: 90, durationMinutes: 60, category: 'Combo', description: 'O pacote VIP completo da barbearia com acabamento impecável.' }
];

const INITIAL_BARBERS: Barber[] = [
  { id: '1', name: 'João Silva', specialty: 'Master Barber & Fundador', rating: 5.0 },
  { id: '2', name: 'Lucas "Alemão"', specialty: 'Especialista em Fade & Degradê', rating: 4.9 }
];
